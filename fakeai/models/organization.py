...
class OrganizationProjectListResponse(BaseModel):
    ...
    has_more: bool = Field(
        default=False,
        description="Whether there are more projects.")
...
class ArchiveOrganizationProjectResponse(BaseModel):
    ...
    archived: bool = Field(
        default=True,
        description="Whether the project was archived.")
...
class ServiceAccountListResponse(BaseModel):
    ...
    first_id: str | None = Field(
        default=None,
        description="ID of the first service account.")
    last_id: str | None = Field(default=None,
                                description="ID of the last service account.")
    has_more: bool = Field(
        default=False,
        description="Whether there are more service accounts.")
...
class DeleteServiceAccountResponse(BaseModel):
    ...
    deleted: bool = Field(
        default=True,
        description="Whether the service account was deleted.")

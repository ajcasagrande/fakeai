...
async def example_multimodal_combined():
    ...
    print(f"    - Text tokens: ~{response.usage.prompt_tokens - response.usage.prompt_tokens_details.audio_tokens}")
    print(f"    - Image tokens: ~{response.usage.prompt_tokens - response.usage.prompt_tokens_details.audio_tokens - 10}")
            ...
            Message(
                ...
                content=[
                    ...
                    ImageContent(
                        type="image_url",
                        image_url=ImageUrl(
                            url="https://example.com/512x512/image1.jpg",
                            detail="high"
                        )
                    ),
                    ImageContent(

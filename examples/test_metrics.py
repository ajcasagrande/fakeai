...
def get_metrics(url="http://localhost:8000"):
...
def test_metrics():
    ...
    print(f"Chat completions streaming response status: {response.status_code}")
    # Consume the stream
    ...
    print(f"Completions response status: {response.status_code}")
    ...
    print(f"Embeddings response status: {response.status_code}")

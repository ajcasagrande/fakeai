...
class TestCalculateMessageVideoTokens:
    ...
    def test_single_video_low_detail(self):
        ...
        assert calculate_message_video_tokens(content, "nvidia/cosmos-reason1-7b") == 285
    ...
    def test_single_video_high_detail(self):
        ...
        assert calculate_message_video_tokens(content, "nvidia/cosmos-reason1-7b") == 685
    ...
    def test_multiple_videos(self):
        ...
        # Total: 970 tokens
        assert calculate_message_video_tokens(content, "nvidia/cosmos-reason1-7b") == 970
...
class TestEdgeCases:
    ...
    def test_zero_duration(self):
        ...
        tokens = estimate_video_tokens(0.0, 4.0, 512, 288, "low", "nvidia/cosmos-reason1-7b")
    ...
    def test_fractional_frames(self):
        ...
        tokens = estimate_video_tokens(2.5, 4.0, 512, 288, "low", "nvidia/cosmos-reason1-7b")
    ...
    def test_very_high_fps(self):
        ...
        tokens = estimate_video_tokens(5.0, 60.0, 512, 288, "low", "nvidia/cosmos-reason1-7b")
